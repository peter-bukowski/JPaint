...
public class drawEllipse implements drawStrategy {
    ...
    public drawEllipse( PaintCanvasBase paintCanvas, IApplicationState appState,int x,int y, int width,int height,ShapeColor primary, ShapeColor secondary,ShapeShadingType shading){
