...
public class drawRectangle implements drawStrategy {
    ...
    public drawRectangle(PaintCanvasBase paintCanvas, IApplicationState appState,int x,int y, int width,int height, ShapeColor primary, ShapeColor secondary,ShapeShadingType shading){
