...
import java.awt.*;
 ...
 class TriangleShape extends Shape {
     ...
     private drawStrategy drawTriangle;
     private ShapeColor primary,secondary;
     private ShapeShadingType shading;



     public TriangleShape(Point startPoint, Point endPoint, PaintCanvasBase paintCanvas,IApplicationState appState) {
    ...
    public void drawShape(){
           drawTriangle= new drawTriangle(paintCanvas,appState,getNewX(),getNewY(),primary,secondary,shading);
