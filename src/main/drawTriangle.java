...
public class drawTriangle implements drawStrategy {
    ...
    public drawTriangle(PaintCanvasBase paintCanvas, IApplicationState appState, int[] x, int[] y, ShapeColor primary, ShapeColor secondary,ShapeShadingType shading){
